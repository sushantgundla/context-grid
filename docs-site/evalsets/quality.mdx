...
CAUTION [evalset]: 3 answerable questions can only detect differences of about 1.00 or larger. Anything smaller than that on a leaderboard built from this set is noise
...
| `.detectable_difference` | `minimum_detectable_difference(self.answerable)` |
| `.is_portable` | `portable == answerable` |
| `.can_support(difference) -> bool` | can this set reliably see a gap of this size |
